  ...
  return [
    {
      ...
      getComponent(nextState, cb) {
        const importModules = Promise.all([
          System.import('containers/SalesLogin/reducer'),
          System.import('containers/SalesLogin/sagas'),
          System.import('containers/SalesLogin'),
        ]);

        const renderRoute = loadModule(cb);

        importModules.then(([reducer, sagas, component]) => {
          injectReducer('salesLogin', reducer.default);
      ...
      path: '/sales/manage',
      name: 'salesManagerPage',
      getComponent(nextState, cb) {
        const importModules = Promise.all([
          System.import('containers/SalesManagerPage/reducer'),
          System.import('containers/SalesManagerPage/sagas'),
          System.import('containers/SalesManagerPage'),
        ]);

        const renderRoute = loadModule(cb);

        importModules.then(([reducer, sagas, component]) => {
          injectReducer('salesManagerPage', reducer.default);
          injectSagas(sagas.default);
          renderRoute(component);
        });
      ...
      path: '/sales/associate',
      name: 'salesAssociatePage',
      getComponent(nextState, cb) {
        const importModules = Promise.all([
          System.import('containers/SalesAssociatePage/reducer'),
          System.import('containers/SalesAssociatePage/sagas'),
          System.import('containers/SalesAssociatePage'),
        ]);

        const renderRoute = loadModule(cb);

        importModules.then(([reducer, sagas, component]) => {
          injectReducer('salesAssociatePage', reducer.default);
          injectSagas(sagas.default);
          renderRoute(component);
        });
